...
const sizeOptionItems = computed(() => props.runtime.sizeOptions.value as OutputOption[]);
const qualityOptionItems = computed(() => props.runtime.qualityOptions.value as OutputOption[]);
</script>
